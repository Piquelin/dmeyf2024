...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$future <- c(202109, 202108, 202107, 
                          202106, 202105, 202104, 202103, 202102, 202101,
                          202012, 202011, 202010, 202009, 202008, 202007,
                          202006, 202005, 202004, 200203, 202002, 202001, 
  ...
  param_local$final_train$training <- c(202107, 202106, 202105, # 202104,
                                        ...
                                        202005, 202002, 202001, # 202004, 200203
                                        201912, 201911, 201910, 201909, 201908, 201907, 201906,
                                        201905, 201904, 201903) # 201902, 201901


  param_local$train$training <- c( 202106, 202105, # 202104,
                                   202103, 202102, 202101,
                                   202012, 202011, 202010, 202009, 202008, 202007, 
...
HT_tuning_base <- function( pinputexps, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$lgb_param <- list(
    ...
    num_iterations = 4000, # un numero muy grande, lo limita early_stopping_rounds
...
c03_predict_todo <- function( pnombrewf )
{
  ...
  CN_canaritos_asesinos_base(ratio=0.6, desvio=2.0)
  ...
  # Etapas finales
  fm <- FM_final_models_lightgbm( c(ht, ts8), ranks=c(2), qsemillas=1)
  SC_scoring( c(fm, ts8) )
